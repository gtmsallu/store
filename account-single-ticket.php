...
<!-- Mirrored from demo.createx.studio/cartzilla/account-single-ticket.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jul 2020 09:34:08 GMT -->
<head>
    <meta charset="utf-8">
    <title>Cartzilla | Signle ticket
    </title>
    <!-- SEO Meta Tags-->
        ...
        <div class="navbar navbar-expand-lg navbar-light navbar-stuck-menu mt-n2 pt-0 pb-2">
          <div class="container">
            <div class="collapse navbar-collapse" id="navbarCollapse">
              ...
              <!-- Primary menu-->
              <ul class="navbar-nav">
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="index.php" data-toggle="dropdown">Home</a>
                </li>
                <li class="nav-item dropdown"><a class="nav-link dropdown-toggle" href="shop-grid-ls.php" data-toggle="dropdown">Shop</a>
                </li>
      ...
      <div class="row">
        ...
        <section class="col-lg-8">
          ...
          <div class="d-none d-lg-flex justify-content-between align-items-center pt-lg-3 pb-4 pb-lg-5 mb-lg-4">
            ...
            </div><a class="btn btn-primary btn-sm" href="account-signin.php"><i class="czi-sign-out mr-3"></i>Sign out</a>
          </div>
