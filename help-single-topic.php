...
<!-- Mirrored from demo.createx.studio/cartzilla/help-single-topic.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jul 2020 09:37:05 GMT -->
<head>
    <meta charset="utf-8">
    <title>Cartzilla | Single topic
    </title>
    <!-- SEO Meta Tags-->
          ...
          <div class="container">
            <div class="collapse navbar-collapse" id="navbarCollapse">
              ...
              <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown active"><a class="nav-link dropdown-toggle" href="#" data-toggle="dropdown">Support</a>
                  <ul class="dropdown-menu">
    ...
    <div class="bg-secondary py-4">
      <div class="container d-lg-flex justify-content-between py-2 py-lg-3">
        <div class="order-lg-2 mb-3 mb-lg-0 pt-lg-2">
          <nav aria-label="breadcrumb">
            <ol class="breadcrumb flex-lg-nowrap justify-content-center justify-content-lg-start">
              ...
              <li class="breadcrumb-item text-nowrap"><a href="help-topics.php">Help center</a>
              </li>
        ...
        <div class="order-lg-1 pr-lg-4 text-center text-lg-left">
          <h1 class="h3 mb-0">Single topic</h1>
        </div>
      </div>
    </div>
    <!-- Page Content-->
      ...
      <div class="row">
        ...
        <div class="col-lg-9">
          ...
          <section class="container text-center pt-5 mt-2">
            <h2 class="h4 pb-3">Haven't found the answer? We can help.</h2><i class="czi-help h3 text-primary d-block mb-4"></i><a class="btn btn-primary" href="help-submit-request.php">Submit a request</a>
...
<!-- Mirrored from demo.createx.studio/cartzilla/help-single-topic.php by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 27 Jul 2020 09:37:06 GMT -->
</html>