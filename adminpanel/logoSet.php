...
<div class="container-fluid">
	...
	<div class="row mx-auto w-50 ">
		<div class="container-fluid  shadow bg-light">
			...
			?>
			<form action="controller/dblogo.php" method="post" enctype="multipart/form-data">
				<div class="row">
					
					<div class="col-6">
						<label for="text" class="text">Frontend logo (max height 40px)</label>
					</div>
					<div class="col-6">
				...
				<div class="row">
					...
					<div class="col-6">
						<div class="form-group">
							<input class="form-control" name="logo1" type="file" accept="image/*" accept="image/*">
						</div>
				...
				<div class="row">
					...
					<div class="col-6 mb-4">
						<button type="submit" name="submit" class="form-control btn btn-warning"><i class="fas fa-edit"></i>Update</button>
					</div>
				</form>
			</div>
